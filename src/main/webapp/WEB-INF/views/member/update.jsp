		...
		<article class="setting__content">
			...
			<form id="profileUpdate"" onsubmit="update(${principal.member.id}, event)">
				<div class="content-item__02">
					...
					<div class="item__input">
						<input type="text" name="name" placeholder="이름"
							value="${principal.member.name}" required="required" />
					</div>
				</div>
				...
				<div class="content-item__04">
					...
					<div class="item__input">
						<input type="password" name="password" placeholder="패스워드"  autocomplete="off" required="required" />
					</div>
				</div>
				...
				<div class="content-item__08">
					...
					<div class="item__input">
						<input type="text" name="email" placeholder="이메일"
							value="${principal.member.email }" readonly="readonly" />
					</div>
				</div>
